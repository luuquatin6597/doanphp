...
<head>
	...
	<title>Modern Human | Home Page</title>
		...
		<div class="container-fluid">
			<div class="furniture-container homepage-container">
				<div class="row">
					...
					<div class="col-xs-12 homebanner-holder">
						<!-- ========================================== SECTION – HERO ========================================= -->
						...
						<div class="info-boxes inner-bottom-vs wow fadeInUp">
				...
				<!-- ============================================== TABS ============================================== -->
				<div class="sections prod-slider-small inner-bottom-vs">
					<div class="row">
						<div class="col-md-6">
							<section class="section">
								<h3 class="section-title">SUPER OFFERS</h3>
								<div class="outer-top-xs">
									<div class="owl-carousel homepage-owl-carousel custom-carousel owl-theme"
										data-item="2">
										<?php
				...
				<section class="section featured-product inner-bottom-vs wow fadeInUp">
					<h3 class="section-title">KIDS</h3>
					<div class="outer-top-xs">
						<div class="owl-carousel best-seller custom-carousel owl-theme">
							<?php
