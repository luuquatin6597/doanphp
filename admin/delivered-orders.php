										...
										<tbody>
											...
											$query = mysqli_query($con, "
												SELECT 
													...
													GROUP_CONCAT(CONCAT(products.productName, ' (x', orderdetails.quantity, ')') SEPARATOR ', ') AS products_summary,
											...
											while ($row = mysqli_fetch_array($query)) {
												...
												<tr>
													...
													<td><?php echo htmlentities($row['products_summary']); ?></td>
													<td><?php echo htmlentities('$' . $row['total']); ?>
													</td>
